# Contributing to t3-code Chocolatey Package

Thank you for considering contributing to the t3-code Chocolatey Package! Your help is greatly appreciated.
...
2. **Clone your fork**: Clone your forked repository to your local machine using the following command:
   ...
   ```bash
   git clone https://github.com/your-username/t3-code-chocolatey-package.git
   ```
...
If you encounter any issues or have suggestions for improvements, please open an issue in the [GitHub Issues](https://github.com/MKAbuMattar/t3-code-chocolatey-package/issues) section.
